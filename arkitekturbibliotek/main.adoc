...
Oppbyggingen av dette arkitekturbiblioteket følger i grove trekk strukturen som angitt av TOGAF og Nasjonalt rammverk for samhandlingsarkitektur (NIF).
...
. link:./kravbibliotek/[Kravbibliotek]
. link:./referanseinformasjon/[Referansebibliotek]

...
:doctitle: Steg 3 - Identifisere referansearkitektur
...
== Steg 3 - Identifisere referansearkitektur
...
image:Prosess SBL med angivelse av referansearkitektur.png[alt="bad!", width=750]

Mapping til referansearkitektur for  konkurs og lønnsgaranti vil da se slik ut:

image:Samhandling bostyrer og NAV.png[alt="bad!", width=1100]

...
:imagesdir!:
:imagesdir: ./images
image:bokfront-navigating-the-labyrinth.png[width=100, height=100]

////
////

//image:i-arbeid.png[width=75, height=75] Uferdig innhold - første versjon er fremdeles i arbeid
...
image:data-management-functions.png[]
...
image:dmbok2-framework.png[width=400, height=400]
...
image:the-data-lifecycle.png[width=400, height=400]

=== Chapter 4 Data Ethics

image:ethical-risk-model.png[]
...
image:architecture-domains-purpose.png[width=400, height=400]

image:architecture-domains-elements.png[width=400, height=400]

image:architecture-domains-dependencies.png[width=400, height=400]

image:architecture-domains-roles.png[width=400, height=400]
...
image:conceptual-dw-bi-and-big-data.png[]

...
. *Importer og ta en titt på modellene fra Bergen Kommune?*
+
sad

. *Modeller (deler av) Difis fellesløsninger.*
+
Lag en modell med Application Components og Application Services for f.eks. ID-porten.

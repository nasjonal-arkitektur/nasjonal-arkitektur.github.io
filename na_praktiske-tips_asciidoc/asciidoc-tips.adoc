...
Om du ikke har mulighet til å installere programvare på din maskin og ikke vil vente til du får hjelp av noen med administratorrettigheter, kan du forsøke å arbeide direkte i nettleseren under https://github.com/nasjonal-arkitektur/nasjonal-arkitektur.github.io , uten å klone til lokalt filområde. Du kan alternativt bruke asciidoclive; ref. https://asciidoclive.com/edit/scratch/1
...
Absolutt minimum metadata for (norske) asciidoc-filer er at det oppgis følgende:
 ...
 [underline]lang: Språk, f.eks. "no" for norsk

...
3. Arbeid direkte i nettleseren under https://github.com/nasjonal-arkitektur , uten å klone til lokalt filområde;  eventuelt bruk asciidoclive for asciidoc-dokumentasjon; ref. https://asciidoclive.com/edit/scratch/1
...
a. Åpne  GitHub-biblioteket i nettleser, dvs.   https://github.com/nasjonal-arkitektur

...
image:../na_felles/images/i-arbeid.png[width=75, height=75]  Omstrukturering og tillegg i arbeid
...
3. Arbeid direkte i nettleseren under https://github.com/nasjonal-arkitektur/nasjonal-arkitektur.github.io , uten å klone til lokalt filområde;  eventuelt bruk asciidoclive for asciidoc-dokumentasjon; ref. https://asciidoclive.com/edit/scratch/1
...
a. Åpne  GitHub-biblioteket i nettleser, dvs.   https://github.com/nasjonal-arkitektur/nasjonal-arkitektur.github.io
